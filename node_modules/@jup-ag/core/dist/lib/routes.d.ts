...
export declare function computeInputRouteSegments({ inputMint, outputMint, tokenRouteSegments, swapMode, intermediateTokens, onlyDirectRoutes, }: {
    inputMint: string;
    outputMint: string;
...
export declare function computeRouteMap(tokenRouteSegments: TokenRouteSegments, intermediateTokens?: string[], onlyDirectRoutes?: boolean, enforceSingleTx?: boolean): Map<string, string[]>;
interface SplitTradeRequiredParams {
    hasSerumOpenOrderInstruction: boolean;
}
export declare function isSplitSetupRequired(marketInfos: MarketInfo[], { hasSerumOpenOrderInstruction }: SplitTradeRequiredParams): boolean;
