...
const port = __importStar(require("@port.finance/port-sdk"));
const quarry_sdk_1 = require("@quarryprotocol/quarry-sdk");
const constants_1 = require("../constants");
class PortWithLMHandler {
    constructor(strategyProgram) {
        this.strategyProgram = strategyProgram;
        //@ts-ignore
        this.quarrySDK = quarry_sdk_1.QuarrySDK.load({ provider });
    }
