...
export const getAssociatedTokenAccount = (tokenMint, owner) => __awaiter(void 0, void 0, void 0, function* () {
    return yield Token.getAssociatedTokenAddress(ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, tokenMint, owner);
});
...
export const getOrCreateATAInstruction = (tokenMint, owner, connection, opt) => __awaiter(void 0, void 0, void 0, function* () {
    let toAccount;
    try {
        toAccount = yield Token.getAssociatedTokenAddress(ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, tokenMint, owner, opt === null || opt === void 0 ? void 0 : opt.allowOwnerOffCurve);
...
export const unwrapSOLInstruction = (walletPublicKey) => __awaiter(void 0, void 0, void 0, function* () {
    const wSolATAAccount = yield Token.getAssociatedTokenAddress(ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, SOL_MINT, walletPublicKey);
    if (wSolATAAccount) {
