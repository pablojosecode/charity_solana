...
class StableSwap {
    ...
    computeOutAmount(sourceAmount, swapSourceAmount, swapDestinationAmount, tradeDirection) {
        ...
        const outAmount = upscaledSwapDestinationAmount.sub(new anchor_1.BN(newSwapDestinationAmount.toString()));
        return tradeDirection == _1.TradeDirection.AToB ? this.downscaleTokenB(outAmount) : this.downscaleTokenA(outAmount);
    }
