...
export const withdrawObligationCollateralInstruction = (collateralAmount, srcCollateralPubkey, // 0
dstCollateralPubkey, // 1
withdrawReservePubkey, // 2
obligationPubkey, // 3
lendingMarketPubkey, // 4
lendingMarketAuthorityPubkey, // 5
obligationOwnerPubkey, // 6
lendingProgramId = PORT_LENDING, optStakeAccountPubkey, // 9
optStakingPoolPubkey // 10
) => {
    ...
    if (optStakeAccountPubkey && optStakingPoolPubkey) {
        keys.push(getAccess(optStakeAccountPubkey, AccessType.WRITE), getAccess(optStakingPoolPubkey, AccessType.WRITE), getAccess(PORT_STAKING, AccessType.READ));
    }
...
//# sourceMappingURL=withdrawObligationCollateral.js.map