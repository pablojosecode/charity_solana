...
//   8. `[]` Clock sysvar.
//   9. `[]` Token program id.
export const redeemReserveCollateralInstruction = (collateralAmount, sourceCollateral, destinationLiquidity, reserve, reserveCollateralMint, reserveLiquiditySupply, lendingMarket, lendingMarketAuthority, transferAuthority, lendingProgramId = PORT_LENDING) => {
