...
//   6. `[]` Clock sysvar.
//   7. `[]` Token program id.
export function repayObligationLiquidityInstruction(liquidityAmount, srcLiquidityPubkey, // 0
dstLiquiditySupplyPubkey, // 1
repayReservePubkey, // 2
obligationPubkey, // 3
lendingMarketPubkey, // 4
transferAuthorityPubkey, // 5
