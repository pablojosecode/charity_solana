...
exports.AssetContext = void 0;
const defaultAssetConfig_1 = require("../utils/defaultAssetConfig");
class AssetContext {
    ...
    findConfig(mintId) {
        ...
        return (_a = this.cache.get(key)) !== null && _a !== void 0 ? _a : defaultAssetConfig_1.DEFAULT_ASSET_CONFIG;
    }
    findConfigBySymbol(symbol) {
        var _a;
        return (_a = this.bySymbol.get(symbol)) !== null && _a !== void 0 ? _a : defaultAssetConfig_1.DEFAULT_ASSET_CONFIG;
    }
    findConfigByReserveId(reserveId) {
        var _a;
        return (_a = this.byReserveId.get(reserveId.toBase58())) !== null && _a !== void 0 ? _a : defaultAssetConfig_1.DEFAULT_ASSET_CONFIG;
    }
}
