...
exports.withdrawFeeInstruction = void 0;
...
//   6. `[]` Rent sysvar.
//   7. `[]` Token program id.
const withdrawFeeInstruction = (reservePubkey, // 0
lendingMarketPubkey, // 1
lendingMarketAuthorityPubkey, // 2
lendingMarketOwnerPubkey, // 3
reserveFeePubkey, // 4
dstFeePubkey, // 5
lendingProgramId = constants_1.PORT_LENDING) => {
    const dataLayout = BufferLayout.struct([BufferLayout.u8("instruction")]);
    const data = Buffer.alloc(dataLayout.span);
    dataLayout.encode({
        instruction: instruction_1.LendingInstruction.WithdrawFee,
    }, data);
    const keys = [
        ...
        (0, Instructions_1.getAccess)(lendingMarketOwnerPubkey, Instructions_1.AccessType.SIGNER),
        (0, Instructions_1.getAccess)(reserveFeePubkey, Instructions_1.AccessType.WRITE),
        (0, Instructions_1.getAccess)(dstFeePubkey, Instructions_1.AccessType.WRITE),
...
exports.withdrawFeeInstruction = withdrawFeeInstruction;
