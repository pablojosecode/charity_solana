...
var SerumMarket = /** @class */ (function (_super) {
    __extends(SerumMarket, _super);
    function SerumMarket(name, tokenIdA, tokenIdB, market, bids, asks, events, requests, vaultA, vaultB, vaultSigner) {
        ...
        _this.vaultA = vaultA;
        _this.vaultB = vaultB;
        _this.vaultSigner = vaultSigner;
        if (name !== tokenIdA + "/" + tokenIdB) {
            throw new Error("Incorrect name!");
        }
        _this.mintA = mints_1.MINTS[tokenIdA];
        _this.mintB = mints_1.MINTS[tokenIdB];
        return _this;
    }
    SerumMarket.prototype.getSwapper = function (_args) {
...
//# sourceMappingURL=serumConstants.js.map